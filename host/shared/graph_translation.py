"""Translates a GraphDocument (host/shared/webui/graph_editor.js's
exportGraphDocument() shape) into the plain-JSON schema MacroRunner
consumes (see runner.py's module docstring).
...
runner.py's module docstring for the full schema.
"""
