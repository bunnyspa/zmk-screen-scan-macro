...
from command import Command, RecordingCommandSink
from cursor import CursorConvergenceError, _wait_for_settled_position, click_at_target
import protocol as wire  # shared/protocol.py - see pytest.ini's pythonpath
...
# within click_rect by default (see cursor.py's module docstring) -
