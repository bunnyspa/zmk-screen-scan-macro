...
thread (a threading.Event, the same pattern runner.py's own
...
from win32_focus import find_window_handle, focus_window
...
class PickController(QtCore.QObject):
    ...
    def pick_click_region(self, target_window_title):
        ...
        runner.py's own _await_confirmation()."""
    ...
    def show_reference_region(self, target_window_title, abs_image_path, region_x, region_y):
        ...
        (bridge.py knows the profile's images/ dir; this module
        doesn't need to)."""
