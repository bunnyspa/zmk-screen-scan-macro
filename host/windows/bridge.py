...
framework-agnostic ProfileManager/profile_store (host/shared/) - reused
as-is, no changes. Every method here is a thin wrapper: catch
...
from profile_manager import ProfileError
import branch_images
import graph_translation
...
class WebBridge:
    ...
    def _thumbnail_data_uri(abs_path):
        ...
        local resource" error - index.html lives under host/shared/webui/,
        but profile images live under profiles/<name>/images/, a completely
